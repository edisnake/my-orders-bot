...
# Robot Orders Creator

  This project is about automating a human task by creating robot orders using the Robocorp Framework for automation. It works as follows:

  - The robot downloads the orders file (.csv) and complete all the orders in the file.
  ![alt text](image.png)
